...
export default async function AnalyticsHubPage(){
 ...
 const views=[
  ...
  {href:"/maintenance",title:"设备效率与维护",tag:"设备",copy:"结合累计工时、维护到期和最近生产记录评估设备状态。",allowed:true},
 ];
 ...
 <section className={styles.principles}><div><b>事实优先</b><p>无法识别的任务与耗材保持待确认，不猜测利润。</p></div><div><b>预计 / 实际分离</b><p>标准成本、任务核算和称重校准分别留痕。</p></div><div><b>可追溯</b><p>指标应能回到订单、打印任务和耗材流水。</p></div></section>
