...
export default function Home() {
  ...
  return <main className="shell">
    <aside className="sidebar">
      ...
      <div className="sidebar-bottom"><div className="system-state"><i/> {loading?"正在同步数据":"数据已同步"}</div><a className="team-nav-link" href="/fleet">▣ 打印机中枢</a><a className="team-nav-link" href="/team">♙ 员工与权限</a><button onClick={() => setSection("系统中心")}>⚙ 系统中心</button><div className="profile"><span>郑</span><div><strong>管理员</strong><small>私有工作区</small></div><em>•••</em></div></div>
    </aside>
