...
const tables=["print_items","material_batches","orders","order_items","item_materials","print_jobs","print_job_events","inventory_transactions","print_files","printers","printer_commands","spoolman_spools"] as const;
