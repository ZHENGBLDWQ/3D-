...
export const metadata: Metadata = {
  title: "CreateX · 3D 打印经营管理",
  description: "统一管理打印物品、耗材库存、客户订单与打印队列。",
  openGraph: {
    title: "CreateX · 3D 打印经营管理",
    description: "统一管理打印物品、耗材库存、客户订单与打印队列。",
    images: [{ url: "/og.png", width: 1680, height: 945, alt: "CreateX 3D 打印经营管理" }],
  },
  twitter: {
  ...
  if (!user) {
    ...
    return <html lang="zh-CN"><body><main className="signin-shell">
      <section className="signin-card">
        <img className="signin-logo" src="/createx-logo.png" alt="CreateX Creative Tech Lab"/>
        <p>CREATEX WORKSPACE</p>
        ...
        <small>{needsSetup?"邮箱和密码只用于此 CreateX 工作区。":"仅已授权的管理员和员工账号可以进入工作区。"}</small>
      </section>
    </main></body></html>;
  }
